...
pyqtlet allows you to bring in these leaflet maps into PyQt5 or PySide in just a couple of lines. It provides a mapWidget (which is a QWidget) as well as a namespace (L) in order to mimic the Leaflet API.
