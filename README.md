...
pyqtlet is a wrapper for Leaflet maps in PyQt5, PySide2 or PySide6. In construction and design, it mimics the [official leaflet api](http://leafletjs.com/reference-1.3.0.html) as much as possible.
...
``` bash
pip3 install PyQt5 # or pip3 install PySide6 or pip3 install PySide2
